  ...
  const handleFetchData = async () => {
    try {
      ...
      const plotData = await axios.get(
        "http://34.201.98.222/get_demand_plot_data"
      );
